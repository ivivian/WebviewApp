...
public class Utils {
    ...
    public static String fchannelid = "";
    public static String frequestid = "";
    public static String ftitle = "";
    public static String fcontent = "";
    public static String fcustomcontent="";
    public static String ftype="";
    public static String fversion="0";
    ...
    //http请求
    public static String executeHttpGet(String furl) {
        String result = "9999";
        URL url = null;
